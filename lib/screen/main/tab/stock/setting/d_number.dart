...
class NumberDialog extends DialogWidget<int> {
  ...
  @override
  DialogState<NumberDialog> createState() => _NoitificationDialogState();
}

class _NoitificationDialogState extends DialogState<NumberDialog> {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Column(
        ...
        children: [
         RoundedContainer(child: Column(children: [
